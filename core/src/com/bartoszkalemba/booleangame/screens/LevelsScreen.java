...
public class LevelsScreen extends AbstractScreen{
	...
	private final int numberLevels = 40; // liczba poziomow
	...
	public LevelsScreen(final BooleanGame game) {
		super(game);
	}
	...
	protected void init() {
		...
		if (game.getUnlockLevel() == 0)
			unlockLevel = 1;
		else unlockLevel = game.getUnlockLevel();
	...
	private void createTitle() {
		...
		titleLabel = new Label("normal", labelStyle);
